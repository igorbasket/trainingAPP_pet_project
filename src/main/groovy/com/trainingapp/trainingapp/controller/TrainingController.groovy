...
//    }
    ...
    @DeleteMapping('/delTrainingByName/{nameTrain}')
    @CrossOrigin
    void deleteTrainingByName(@PathVariable('nameTrain') String name){
        trainingService
                .deleteOneTraining(name)
    }

    @DeleteMapping('/delTrainingById/{idTrain}')
    @CrossOrigin
    void deleteTrainingById(@PathVariable('idTrain') Long id){
        trainingService
                .deleteOneTrainingById(id)
    }
